        ...
        <>
            <div className='instructor-dash-column-alt'>
                ...
                <div className='instructions-bubble'>
                    ...
                    populate it with students, then proceed. (refresh if you don't see the group added)
                </div>
                ...
                <div className='instructions-bubble'>
                    Finally, click CREATE and cross your fingers.  If all goes well, the scenario should be added to the list.  Note: currently, you must refresh the page to see a new scenario.
                </div>
