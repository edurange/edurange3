...
function Scenario_controller2() {
    ...
    useEffect(() => {
        async function getYaml() {
            try {
                ...
                const contentYAML = contentReturn?.data?.contentYAML;
                const contentChapters = contentYAML?.StudentGuide?.Chapters;
                
                
                // const guideReturn = buildGuide(scenarioID, contentJSON);
                set_guideContent_state(contentData);
                // set_guideBook_state(guideReturn);
                set_guideBook_state(contentChapters);
    ...
    console.log('guidebookstate: ', guideBook_state)
    ...
    console.log('scenques', scenario_questions)

    scenario_questions.map(question => scenario_points += question.points_possible)
...
export default Scenario_controller2;
