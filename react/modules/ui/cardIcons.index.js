...
import getting_started from '@assets/img/svg/small/getting_started.svg';
import kick from '@assets/img/svg/small/kick.svg';
import survivalist from '@assets/img/svg/small/survivalist.svg';
import telephoneWoman from '@assets/img/svg/small/telephoneWoman.svg';
import turtle from '@assets/img/svg/small/turtle.svg';
import twoHeads from '@assets/img/svg/small/twoHeads.svg';
import wrangler from '@assets/img/svg/small/wrangler.svg';

import elf2 from '@assets/img/svg/small/elf.svg'