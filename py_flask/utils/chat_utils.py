...
# def getChatLibrary():
#     """
#     Fetches all chat messages and channel user entries from the database, 
#     then returns:
#         - an unordered list of chat msg dictionaries, one for each message 
#         - a dictionary of user-accessible channels, keyed by user-id.
#     """
#     all_db_chatMessages_rawObj = ChatMessages.query.all()
#     unordered_messages_list = createListOfChats(all_db_chatMessages_rawObj)
